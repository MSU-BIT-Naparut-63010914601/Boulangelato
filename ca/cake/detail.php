...
<body>
            ...
            <nav class="navbar navbar-light bg-white navbar-expand-xl">
                ...
                <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                    ...
                    <div class="d-flex m-3 me-0">
                        ...
                        <!-- ล็อกอิน -->
                        <a href="loginM.php" class="my-auto">
                ...
                <div class="modal-body d-flex align-items-center">
                    <div class="input-group w-75 mx-auto d-flex">
                        <form method="post" action="">
                            <input type="search" class="form-control p-3" placeholder="keywords" aria-describedby="search-icon-1" type="text" name="kw" autofocus>
                            <span id="search-icon-1" class="input-group-text p-3" type="submit" name="Submit"><i class="fa fa-search"></i></span>
                        </form>
                    </div>
                </div>
            </div>
    ...
    <div class="container-fluid py-5 mt-5">
        <div class="container py-5">
                    ...
                    <div class="row g-4">
                        <div class="col-lg-6">
                            <div class="border rounded">
                                ...
                                ?>
                                <img src="img2/<?= $p; ?>" height="400" width="400">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <h4 class="fw-bold mb-3"><?php echo $data['p_name'] ?></h4>

                            <h5 class="fw-bold mb-3">ราคา <?php echo $data['p_price'] ?> บาท</h5>
                            ...
                            <p class="mb-4"><?php echo $data['p_detail'] ?></p>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="mb-4">
                                ...
                                <ul class="list-unstyled fruite-categorie">
                                    ...
                                    <li>
                                        <div class="d-flex justify-content-between fruite-name">
                                            <a href="#"><i class="fas fa-apple-alt me-2"></i>cookie</a>
                                            <span>(4)</span>
                                        </div>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <div class="d-flex justify-content-between fruite-name">
                                            <a href="#"><i class="fas fa-apple-alt me-2"></i>pid</a>
                                            <span>(4)</span>
                                        </div>
                                    </li>
                                </ul>
            ...
            <h1 class="fw-bold mb-0">สินค้าขายดี</h1>
            <div class="vesitable">
