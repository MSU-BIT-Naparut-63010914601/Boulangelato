...
if (!isset($_SESSION['user_login'])) {
    ...
    exit(); // ออกจากสคริปต์หลังจากใช้คำสั่ง header
        ...
        <div class="container topbar bg-primary d-none d-lg-block">
            <div class="d-flex justify-content-between">
                ...
                <div class="top-link pe-2">
                    <a href="#" class="text-white"><small class="text-white mx-2">แก้ไขข้อมูล</small>/</a>
                    <a href="view_order.php" class="text-white"><small class="text-white mx-2">ประวัติการสั่งซื้อ</small>/</a>
                    <a href="logout.php" class="text-white"><small class="text-white ms-2">ออกจากระบบ
                        </small></a>
                </div>
            </div>
        </div>
