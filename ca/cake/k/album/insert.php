          ...
          <div class="row g-3">
            ...
            <div class="col-12">
              <label for="pdetail" class="form-label">รายละเอียดสินค้า</label>
                <textarea type="text" class="form-control" name="pdetail"  required></textarea>
              <div class="col-sm-6">
...
if(isset($_POST['Submit'])){
    ...
    $sql2 = "INSERT INTO `product` (`p_id`, `p_name`, `p_detail`, `p_price`, `p_stock`, `p_ext`, `c_id`) VALUES (NULL, '{$_POST['pname']}', '{$_POST['pdetail']}', '{$_POST['pprice']}', '{$_POST['pstock']}', '{$ext}', '{$_POST['cid']}');";
    mysqli_query($conn, $sql2) or die ("เพิ่มข้อมูลสินค้าไม่ได้");
    $idd = mysqli_insert_id($conn);
    @copy($_FILES['pic']['tmp_name'], "img/".$idd.".".$ext);
    echo"<script>";
