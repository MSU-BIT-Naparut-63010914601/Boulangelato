                                    ...
                                    <div class="col-md-6 col-lg-6 col-xl-4">
                                        <div class="rounded position-relative fruite-item">
                                            ...
                                            <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                <h4 class="card-title" style="font-size: 1rem; margin-bottom: auto; color: #333;"><?php echo $data['p_name'] ?></h4>
                                                <!-- <p class="card-title" style="font-size: 1rem; margin-bottom: auto; color: #333;"></p> -->
                                                <div class="d-flex justify-content-between flex-lg-wrap">
                                                    <p class="text-dark fs-5 fw-bold mb-0" style="font-size: 1rem; color: #666;">ราคา <?php echo $data['p_price'] ?> บาท</p>
                                                    <a href="#" class="btn border border-secondary rounded-pill px-3 text-primary"><i class="fa fa-shopping-bag me-1 text-primary"></i> Add to cart</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
